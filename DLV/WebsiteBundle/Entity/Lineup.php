...
class Lineup {
    ...
    public function getLine($lang) {
        
        $timetext = new \DLV\WebsiteBundle\Languages\DateTimeText($lang);
        
        $line = $this->getBand()->getAll($lang);
        $line['time'] = $timetext->getTimeText($this->getTime());
